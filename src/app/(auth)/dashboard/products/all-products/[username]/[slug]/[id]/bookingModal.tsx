      ...
      {!hasUserBooked && (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            <Button className="bg-teal-800 hover:bg-teal-700 text-white w-full rounded p-4 outline-none font-sans">
              Book now
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-md flex flex-col bg-teal-800 border-gray-600 text-white fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <DialogHeader>
            ...
            <div className="grid gap-4 py-4">
              <h1>
                Product Name : <span className="text-teal-500 font-semibold">{title}</span>
              </h1>
              <h1>
                Pay : <span className="text-teal-500 font-semibold">₹{price}</span>
              </h1>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-teal-900/50 border border-sky-200/20 text-sky-100 rounded p-2"
                    >
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="my-8 text-white">
                    ...
                    >
                      <InputOTPGroup className="gap-2">
                        <InputOTPSlot
                          index={0}
                          className="bg-teal-900/50 border-sky-200/20 text-sky-100 w-12 h-12"
                        />
                        <InputOTPSlot
                          index={1}
                          className="bg-teal-900/50 border-sky-200/20 text-sky-100 w-12 h-12"
                ...
                {!otpBox && (
                  <Button
                    ...
                    className="w-full bg-teal-700 text-white hover:bg-teal-500"
                  >
